...
NAMED_CATALOG: List[dict] = [
    ...
    dict(
        content_id="rel_sci_01", title="Science Deep Dive", content_type="relevant",
    ...
    dict(
        content_id="rel_tech_01", title="Tech Innovation Weekly", content_type="relevant",
    ...
    dict(
        content_id="rel_fin_01", title="Personal Finance Explained", content_type="relevant",
    ...
    dict(
        content_id="rel_hist_01", title="History Matters", content_type="relevant",
    ...
    dict(
        content_id="rel_health_01", title="Healthy Living Guide", content_type="relevant",
    ...
    dict(
        content_id="rel_health_02", title="Mental Wellness Essentials", content_type="relevant",
    ...
    dict(
        content_id="rel_news_01", title="Balanced News Digest", content_type="relevant",
    ...
    dict(
        content_id="rel_env_01", title="Climate & Environment", content_type="relevant",
    ...
    dict(
        content_id="rnd_film_01", title="Film Reviews Roundup", content_type="random",
    ...
    dict(
        content_id="rnd_music_01", title="New Music Discoveries", content_type="random",
    ...
    dict(
        content_id="rnd_food_01", title="Food & Recipe Inspiration", content_type="random",
    ...
    dict(
        content_id="rnd_sport_01", title="Sports Highlights", content_type="random",
    ...
    # ── Addictive ────────────────────────────────────────────────────────
    dict(
        content_id="add_scroll_01", title="Endless Scroll Feed", content_type="addictive",
    ...
    dict(
        content_id="add_satisfy_01", title="Satisfying Videos Compilation", content_type="addictive",
    ...
    dict(
        content_id="add_gaming_01", title="Gaming Livestream Highlights", content_type="addictive",
    ...
    dict(
        content_id="add_social_01", title="Social Drama & Reactions", content_type="addictive",
    ...
    dict(
        content_id="add_social_02", title="Influencer Life Updates", content_type="addictive",
    ...
    dict(
        content_id="mis_outrage_01", title="THEY Don't Want You to Know This", content_type="misleading",
    ...
    dict(
        content_id="mis_outrage_02", title="Shocking Truth Revealed", content_type="misleading",
    ...
    dict(
        content_id="mis_click_01", title="You Won't Believe What Happened Next", content_type="misleading",
    ...
    dict(
        content_id="mis_click_02", title="Doctors Hate This One Trick", content_type="misleading",
    ...
    dict(
        content_id="mis_pseudo_01", title="Ancient Secrets Big Pharma Hides", content_type="misleading",
